            ...
            {NavbarLinks.map((link, index) => (
              <li key={index}>
                {link.title === "Catalog" ? (
                  ...
                  <Link to={link?.path}>
                    <p className={`${matchRoute(link?.path) ? "text-yellow-25 hidden md:block" : "text-richblack-25 hidden md:block"}`}>
                      {link.title}
                    </p>
                  </Link>
                )}
              ...
              {NavbarLinks.map((link, index) => (
                <li key={index} className="list-none">
                  {link.title === "Catalog" ? (
                    ...
                    <Link to={link?.path}>
                      <p className={`${matchRoute(link?.path) ? "text-yellow-25 py-2" : "text-richblack-25 py-2"}`}>
                        {link.title}
                      </p>
                    </Link>
                  )}
